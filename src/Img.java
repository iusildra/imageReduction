...
public class Img {
    ...
    private int[][] data; // data[i][j] représente le pixel(i,j) avec i numero colonne et j num ligne avec
                          // ligne 0 en haut, et colonne 0 à gauche
    private int hauteur;
    private int largeur;
    ...
    /**
     * param : B : liste des pixels à mettre en back ground, f et b : entrée du
     * problème de InstanceSegmentation
     * 
     * effet
     * créer une nouvelle image (et ne modifie pas this), dans laquelle on
     * -met en blanc (255) les pixels de b et en gris clair (200) les pixels de B \
     * b (le background devient donc gris clair, sauf les pixels de $b$ qui sont
     * blancs)
     * -met en noir (0) les pixels de f, et laisse l'image intacte pour les pixels
     * de (P \ B) \ f$ (le forground reste intact, sauf les pixels
     * de f qui sont noirs)
     * 
     * 
     * 
